...
var Styles = Module("Styles", {
    ...
    propertyPattern: util.regexp(/* Preprocessors FTW. */ '\n\
            (?:\n\
                (?P<preSpace> <space>*)\n\
                (?P<name> [-a-z]*)\n\
                (?:\n\
    ...
    patterns: memoize({
        get property() util.regexp(/* Preprocessors FTW. */ '\n\
                (?:\n\
                    (?P<preSpace> <space>*)\n\
                    (?P<name> [-a-z]*)\n\
                    (?:\n\
        ...
        get function() util.regexp(/* Preprocessors FTW. */ '\n\
                (?P<function>\n\
                    \\s* \\( \\s*\n\
                        (?: <string> | [^)]*  )\n\
                    \\s* (?: \\) | $)\n\
        ...
        get string() util.regexp(/* Preprocessors FTW. */ '\n\
                (?P<string>\n\
                    " (?:[^\\\\"]|\\\\.)* (?:"|$) |\n\
                    \' (?:[^\\\\\']|\\\\.)* (?:\'|$)\n\
                )\n\
        ...
        get token() util.regexp(/* Preprocessors FTW. */ '\n\
            (?P<token>\n\
                (?P<word> [-\\w]+)\n\
                <function>?\n\
                \\s*\n\
